...
public class ProdottoController {
	...
	public ResponseEntity<Prodotto> saveOrUpdate(){
		try {
			...
			Prodotto prod1 = new Prodotto("Rigatoni","Barilla","10/02/2018",Categoria.ALIMENTI,300.0,1.0,Unita.PEZZO,1.10,"../../assets/imgs/barilla_rigatoni.jpeg",0);
			prodottoService.saveOrUpdate(prod1);
			Prodotto prod2 = new Prodotto("Pesto","Buitoni","30/12/2017",Categoria.ALIMENTI,300.0,1.0,Unita.PEZZO,1.90,"../../assets/imgs/buitoni_pesto.jpeg",0);
			prodottoService.saveOrUpdate(prod2);
			Prodotto prod3 = new Prodotto("Salsiccia","Negroni","15/06/2028",Categoria.ALIMENTI,300.0,1.0,Unita.PEZZO,2.30,"../../assets/imgs/negroni_salsiccia.jpeg",0);
			prodottoService.saveOrUpdate(prod3);
			Prodotto prod4 = new Prodotto("Banane","Chichita","10/02/2018",Categoria.ALIMENTI,300.0,1.0,Unita.ETTO,0.85,"../../assets/imgs/chichita_banane.jpeg",0);
			prodottoService.saveOrUpdate(prod4);
			Prodotto prod5 = new Prodotto("TV LCD","Samsung","",Categoria.PROD_CASA,120.0,1.0,Unita.PEZZO,499.90,"../../assets/imgs/samsung_tv.jpeg",0);
			prodottoService.saveOrUpdate(prod5);
			Prodotto prod6 = new Prodotto("Armadio","Foppapedretti","",Categoria.PROD_CASA,35.0,1.0,Unita.PEZZO,229.90,"../../assets/imgs/foppapedretti_armadio.jpeg",0);
			prodottoService.saveOrUpdate(prod6);
			Prodotto prod7 = new Prodotto("Videocamera","GO_PRO","",Categoria.PROD_CASA,20.0,1.0,Unita.PEZZO,199.99,"../../assets/imgs/gopro_videocamera.jpeg",0);
			prodottoService.saveOrUpdate(prod7);
			Prodotto prod8 = new Prodotto("Shampoo","Garnier","20/08/2020",Categoria.PROD_PERSONA,40.0,1.0,Unita.LITRO,2.90,"../../assets/imgs/garnier_shampoo.jpeg",0);
			prodottoService.saveOrUpdate(prod8);
			Prodotto prod9 = new Prodotto("Deodorante","DOVE","16/01/2021",Categoria.PROD_PERSONA,40.0,1.0,Unita.PEZZO,1.45,"../../assets/imgs/dove_deodorante.jpeg",0);
			prodottoService.saveOrUpdate(prod9);
			Prodotto prod10 = new Prodotto("Profilattici","Durex","29/09/2022",Categoria.PROD_PERSONA,1000.0,1.0,Unita.CHILO,1.00,"../../assets/imgs/durex_profilattici.jpeg",0);
			prodottoService.saveOrUpdate(prod10);
			Prodotto prod11 = new Prodotto("Cane","Labrador","",Categoria.ANIMALI,5.0,1.0,Unita.CHILO,300.0,"../../assets/imgs/labrador_cane.jpeg",0);
			prodottoService.saveOrUpdate(prod11);
			Prodotto prod12 = new Prodotto("Cervo","","",Categoria.ANIMALI,1.0,1.0,Unita.CHILO,1600.0,"../../assets/imgs/cervo.jpeg",0);
			prodottoService.saveOrUpdate(prod12);
			Prodotto prod13 = new Prodotto("Elefante","","",Categoria.ANIMALI,2.0,1.0,Unita.CHILO,9000.0,"../../assets/imgs/elefante.jpeg",0);
